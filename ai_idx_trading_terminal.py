...
<style>
    ...
    div.stFormSubmitButton > button {
        ...
        background: linear-gradient(180deg, rgba(0,255,163,0.16), rgba(0,255,163,0.06));
        color: #00ffa3;
        font-weight: 700;
    }
...
def render_auth_panel(user_db):
    ...
    st.caption("Belum punya akun? Daftar dulu — gratis, cukup username & password, tidak perlu email.")
