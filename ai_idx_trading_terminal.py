...
def render_stock_detail_page(ticker_raw):
    ...
    if hist is None or hist.empty:
        ...
        # Sembunyikan gap akhir pekan (bursa tutup) biar candlestick harian
        # / mingguan tidak ada celah kosong tiap Sabtu-Minggu.
        if PERIOD_OPTIONS[period_label]["interval"] in ("1d", "1wk", "1mo"):
